...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 25, 2015 at 06:08 PM
...
CREATE TABLE IF NOT EXISTS `customers` (
  ...
  `customerName` varchar(50) CHARACTER SET latin1 DEFAULT NULL,
  `contactLastName` varchar(50) CHARACTER SET latin1 DEFAULT NULL,
  `contactFirstName` varchar(50) CHARACTER SET latin1 DEFAULT NULL,
  `phone` varchar(50) CHARACTER SET latin1 NOT NULL,
  `addressLine1` varchar(50) CHARACTER SET latin1 DEFAULT NULL,
  `city` varchar(50) CHARACTER SET latin1 NOT NULL,
  `state` varchar(50) CHARACTER SET latin1 DEFAULT NULL,
  `postalCode` varchar(15) CHARACTER SET latin1 DEFAULT NULL,
  `salesRepEmployeeNumber` int(11) DEFAULT NULL,
  PRIMARY KEY (`customerNumber`),
  KEY `salesRepEmployeeNumber` (`salesRepEmployeeNumber`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_croatian_ci AUTO_INCREMENT=485 ;

--
-- Dumping data for table `customers`
--

INSERT INTO `customers` (`customerNumber`, `customerName`, `contactLastName`, `contactFirstName`, `phone`, `addressLine1`, `city`, `state`, `postalCode`, `salesRepEmployeeNumber`) VALUES
(166, 'Handji Gifts& Co', 'Victorino', 'Wendy', '+65 224 1555', '106 Linden Road Sandown', 'Singaporeee', NULL, '069045', 1088),
(276, 'Anna''s Decorations, Ltd', 'O''Hara', 'Anna', '02 9936 8555', '201 Miller Street', 'North Sydney', 'NSW', '2060', 1611),
(282, 'Souveniers And Things Co.', 'Huxley', 'Adrian', '+61 2 9495 8555', 'Monitor Money Building', 'Chatswood', 'NSW', '2067', 1611),
(293, 'BG&E Collectables', 'Harrison', 'Ed', '+41 26 425 50 01', 'Rte des Arsenaux 41 ', 'Fribourgsss', NULL, '1700', 1611),
(443, 'Feuer Online Stores, Inc', 'Feuer', 'Alexander ', '0342-555176', 'Heerstr. 22', 'Leipzig', NULL, '04179', NULL),
(471, 'Australian Collectables, Ltd', 'Clenahan', 'Sean', '61-9-3844-6555', '7 Allen Street', 'Glen Waverly', 'Victoria', '3150', 1611),
(477, 'Mit Vergnügen & Co.', 'Moos', 'Hanna ', '0621-08555', 'Forsterstr. 57', 'Mannheim', NULL, '68306', NULL),
(480, 'Kremlin Collectables, Co.', 'Semenov', 'Alexander ', '+7 812 293 0521', '2 Pobedy Square', 'Saint Petersburg', NULL, '196143', NULL),
(481, 'Raanan Stores, Inc', 'Altagar,G M', 'Raanan', '+ 972 9 959 8555', '3 Hagalim Blv.', 'Herzlia', NULL, '47625', NULL),
(482, 'ogi', NULL, NULL, '312321123', NULL, 'ogi', NULL, NULL, NULL),
(483, 'ana', NULL, NULL, '31232132', NULL, 'ana', NULL, NULL, NULL),
(484, 'Ogi', NULL, NULL, '123123312', NULL, 'Ogi', NULL, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `employees` (
  ...
  `officeCode` varchar(10) CHARACTER SET latin1 DEFAULT NULL,
...
(1088, 'Markoc', 'Ivassn', '123132', 'marko@marko.gmail', '4', NULL, 'sdaads'),
(1611, 'Fixter', 'Andy', 'x101', 'afixter@classicmodelcars.com', '6', 1088, 'Sales Rep'),
(1612, 'Marsh', 'Peterrrr', 'x102', 'pmarsh@classicmodelcars.com', '6', 1088, 'Sales Rep'),
(1615, 'Ivanovic', 'Ivan', NULL, 'ivan@gmail.com', '4', NULL, NULL),
(1616, 'Markovic', 'Ivan', NULL, 'marko@gmail.com', '4', NULL, NULL);
...
ALTER TABLE `customers`
  ADD CONSTRAINT `customers_ibfk_1` FOREIGN KEY (`salesRepEmployeeNumber`) REFERENCES `employees` (`employeeNumber`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `employees`
  ...
  ADD CONSTRAINT `employees_ibfk_1` FOREIGN KEY (`reportsTo`) REFERENCES `employees` (`employeeNumber`) ON DELETE CASCADE ON UPDATE CASCADE;
